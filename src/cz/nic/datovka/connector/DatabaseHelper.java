...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	public static final String[] received_message_columns = { RECEIVED_MESSAGE_ID, RECEIVED_MESSAGE_ISDS_ID, RECEIVED_MESSAGE_ANNOTATION,
			...
			RECEIVED_MESSAGE_PERSONAL_DELIVERY, SENDER_DATABOX_TYPE, SENDER_IDENT, SENDER_REF_NUMBER, RECEIVED_MESSAGE_STATE, RECEIVED_MESSAGE_LEGALTITLE_LAW,
			...
			RECEIVED_MESSAGE_IS_READ, RECEIVED_MESSAGE_ATTACHMENT_SIZE, RECEIVED_MESSAGE_STATUS_CHANGED };
	...
	public static final String[] sent_message_columns = { SENT_MESSAGE_ID, SENT_MESSAGE_ISDS_ID, SENT_MESSAGE_ANNOTATION, SENT_MESSAGE_ACCEPTANCE_DATE,
			...
			SENT_MESSAGE_ALLOW_SUBST_DELIVERY, SENT_MESSAGE_PERSONAL_DELIVERY, SENT_MESSAGE_SENT_DATE, RECIPIENT_DATABOX_TYPE, RECIPIENT_IDENT,
			RECIPIENT_REF_NUMBER, SENT_MESSAGE_IS_READ, SENT_MESSAGE_ATTACHMENT_SIZE, SENT_MESSAGE_STATE, SENT_MESSAGE_STATUS_CHANGED };
